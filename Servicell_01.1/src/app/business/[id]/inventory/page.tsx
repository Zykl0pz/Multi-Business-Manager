  ...
  return (
    <div className="min-h-screen bg-background p-4">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Segundo nivel: Total de productos y productos bajos de stock */}
        ...
        {/* Tercer nivel: Barra de búsqueda */}
        <div className="mb-6">
        ...
        {/* Cuarto nivel: Recuadro de agregar primer producto o lista de productos */}
